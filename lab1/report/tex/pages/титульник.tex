...
\begin{center}
    ...
    \large Отчёт о выполнении лабораторной работы \\[5pt]
    \large По дисциплине: <<Дискретная математика>>\\[10pt] 
    \large На тему: <<Мультимножества на основе кода Грея>>\\[5pt] 
\end{center}
...
\begin{tabular*}{460pt}{@{\extracolsep{\fill}} l r l}
    Выполнил студент\tabularnewline группы 5130201/40002 & \hspace{60pt} \line(1,0){100} \hspace{-52pt} & Семенов И. А.\\
     & \\
     Проверил \tabularnewline преподаватель & \hspace{60pt} \line(1,0){100} \hspace{-52pt} & Востров А. В. \\
     & \\
     & \\
     & \\
