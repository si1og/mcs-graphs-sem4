...
Логика консультации построена по бинарному дереву решений, представленному на рисунке~\ref{fig:decision-tree}. Каждый внутренний узел дерева соответствует одному вопросу пользователю. Ветви дерева соответствуют ответам <<да>> и <<нет>>, а листья содержат номера конечных рекомендаций, которые затем выводятся правилами CLIPS.
...
]{tex/graphics/fonts-advisor-diagram-a3.pdf}
