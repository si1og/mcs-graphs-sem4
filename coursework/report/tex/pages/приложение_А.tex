\section*{Приложение A. Исходный код QSL-скрипта для создания таблиц базы данных}
\addcontentsline{toc}{section}{Приложение A. Исходный код QSL-скрипта для создания таблиц базы данных}
